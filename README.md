...
| **Channels** | `list_channels`, `get_channel`, `create_channel`, `update_channel`, `delete_channel`, `get_channel_streams`, `bulk_delete_channels`, `bulk_update_channels`, `bulk_regex_update_channels`, `assign_channels`, `batch_set_epg`, `match_epg_all`, `set_logos_from_epg`, `set_names_from_epg`, `set_tvg_ids_from_epg`, `create_channels_from_streams_bulk`, `get_channels_by_uuids`, `reorder_channel`, `set_channel_epg`, `match_channel_epg` |
| **Channel Groups** | `list_channel_groups`, `create_channel_group`, `update_channel_group`, `delete_channel_group` |
| **Streams** | `list_streams`, `get_stream`, `create_channel_from_stream`, `create_stream`, `update_stream`, `delete_stream`, `bulk_delete_streams`, `list_stream_groups`, `list_stream_filter_options`, `list_stream_ids`, `get_streams_by_ids` |
...
| **EPG** | `list_epg_sources`, `get_epg_source`, `create_epg_source`, `update_epg_source`, `delete_epg_source`, `list_epg_data`, `list_epg_programs`, `get_current_programs`, `get_epg_grid`, `get_epg_program`, `create_epg_program`, `update_epg_program`, `delete_epg_program`, `import_epg`, `get_epg_data_entry` |
...
- **File uploads** — `upload_backup`, `upload_epg_source` (multipart file upload, requires different client support)
